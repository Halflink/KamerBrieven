    ...
    while True:
        ...
        for rec in recs:
            ...
            if recorddata is not None:
                ...
                dossiernummer = recorddata.find(".//wetgeving:dossiernummer", ns)
                ondernummer = recorddata.find(".//wetgeving:ondernummer", ns)
                publicatienaam = recorddata.find(".//wetgeving:publicatienaam", ns)
                vergaderjaar = recorddata.find(".//wetgeving:vergaderjaar", ns)
