    ...
    while True:
        ...
        for rec in recs:
            ...
            if recorddata is not None:
                # Zoek naar dcterms- en overheidwetgeving-velden
                ...
                hoofddocument = recorddata.find(".//overheidwetgeving:hoofddocument", ns)
                ...
                records.append({
                    ...
                    "hoofddocument": hoofddocument.text.strip() if hoofddocument is not None and hoofddocument.text else "",
                ...
                records.append({
                    "identifier": "", "title": "", "type": "", "creator": "",
                    "modified": "", "hoofddocument": "", "ondernummer": "", "publicatienaam": ""
                })
...
def schrijf_csv(records: List[Dict], csv_path: str):
    with open(csv_path, mode="w", newline="", encoding="utf-8") as csvfile:
        fieldnames = [
            ...
            "hoofddocument", "ondernummer", "publicatienaam"
        ]
